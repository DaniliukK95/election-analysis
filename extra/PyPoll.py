...
#5a Winning Candidate and Winning Count Tracker. track the winning candidate, vote count, and percentage
winning_candidate = ""
winning_count = 0
...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        #2c) If the candidate does not match any existing candidate add it to the candidate list
